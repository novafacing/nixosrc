...
(def-doom-theme doom-gruvbox-material
  ...
  ;; name        gui       256       16
  ((bg
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#32302f" "#1e1e1e" nil))   ; bg0_h
          ((equal doom-gruvbox-dark-variant "soft") '("#32302f" "#323232" nil))   ; bg0_s
          (t                                        '("#32302f" "#282828" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#32302f" "black" nil))     ; (self-defined)
          ((equal doom-gruvbox-dark-variant "soft") '("#32302f" "#282828" nil))   ; bg0
          (t                                        '("#32302f" "#1e1e1e" nil)))) ; bg_h
   (bg-alt2    '("#ebdbb2" "#504945" "brown"      )) ; bg2 (for region, selection etc.)

   (base0      '("#32302f" "black"   "black"      )) ; (self-defined)
   (base1      '("#3c3836" "#1d1d1d" "brightblack")) ; bg0_h
   (base2      '("#3c3836" "#282828" "brightblack")) ; bg0
   (base3      '("#504945" "#383838" "brightblack")) ; bg1
   (base4      '("#665c54" "#5c5c5c" "brightblack")) ; bg3
   (base5      '("#3c3836" "#6f6f6f" "brightblack")) ; bg4
   (base6      '("#46413e" "#909090" "brightblack")) ; gray
   (base7      '("#5b534d" "#cccccc" "brightblack")) ; fg2
   ...
   (magenta     '("#d3869b" "#cc241d" "magenta"))       ; red
...
(provides 'doom-gruvbox-material)
