...
with pkgs.lib; {
  ...
  programs.zsh = {
    ...
    localVariables = {
      ...
      POWERLEVEL9K_TIME_FORMAT = "%D{%H:%M %a %b %d}";
    ...
    shellAliases = {
      ...
      "dnote" = ''vim "$(date '+%a.%h.%d.%Y.%H.%M').md"'';
      "make" = "make -j8";
      "grep" = "grep --color=auto";
      "vmore" = "vim -";
      "ssh" = "kitty +kitten ssh";
      "bat" = "bat --paging=never";
      "bcmake" = "cmake -S . -B build";
      "ccmake" = "cmake --install build";
      "ns" = "nix-shell";
      "tape" = "appimage-run /etc/nixos/nixos-private/aeriform_tape_1.3.0_linux.AppImage";
    };
    initExtra = ''
      # Generated by Powerlevel10k configuration wizard on 2021-02-21 at 00:24 UTC.
      ...
      # sharp tails, 2 lines, solid, left frame, light-ornaments, compact, concise,
      ...
      # extracts packages argument from args and passes them in $NIX_SHELL_PACKAGES variable.
        ...
        then
          ...
          NIX_BUILD_SHELL="/run/current-system/sw/bin/buildShellShim.zsh" \
        ...
        export PATH=$PATH:/home/novafacing/.local/bin/
        export CEDEV=/home/novafacing/hub/cedev/CEdev
