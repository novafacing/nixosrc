...
with pkgs.lib; {
  ...
  programs.zsh = {
    ...
    initExtra = ''
      # Generated by Powerlevel10k configuration wizard on 2020-05-07 at 12:52 EDT.
      # Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 51840.
      # Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
      # 12h time, slanted separators, slanted heads, sharp tails, 2 lines, dotted, left frame,
